...
\usetheme[minuit]{sharp-rev}
% Not happy with the default style, or bullet ? Define yours !
\setmystyle{missionbullet}{\color{soft}$>$~~}
\setmystyle{assetbullet}{\color{icons}\faIcon{book}}
\setmystyle{fieldratefull}{\color{icons}\faIcon[solid]{circle}}
\setmystyle{fieldrateempty}{\color{icons}\faIcon[regular]{circle}}
% If you need a custom contact, you can define a bullet here :
\setmystyle{custom0bullet}{\color{icons}\faIcon{bolt}}
...
\renewcommand*{\cvsocialcontactspanelfactor}{0.27}
\renewcommand*{\cvextracontactspanelfactor}{0.4}
\title{Novelist}
\begin{document}
\section{Experience}
